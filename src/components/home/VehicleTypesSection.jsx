...
export default function VehicleTypesSection() {
  return (
    <section id="vehicle-types" className="relative bg-neutral-900/40 py-20 sm:py-24 lg:py-28 border-y border-neutral-800/80 overflow-hidden ">
      ...
      <div className="absolute top-1/4 right-1/4 w-125 h-87.5 bg-red-600/5 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute bottom-1/4 left-1/4 w-125 h-75 bg-amber-500/5 blur-[140px] rounded-full pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        {/* Sleek, Minimal, Scrollable Table View (Mobile & Desktop) */}
        <div className="relative mb-14 sm:mb-16">
          {/* Subtle scroll cue for mobile */}
          {/* <div className="flex items-center justify-end gap-1.5 text-[11px] text-neutral-400 mb-2 sm:hidden px-1 font-medium">
            <span>Scroll table</span>
            <span className="text-red-400">→</span>
          </div> */}

          <div className="overflow-x-auto rounded-2xl border border-neutral-800 bg-neutral-950/80 backdrop-blur-md shadow-2xl">
            <table className="w-full min-w-160 text-left border-collapse">
              <thead>
                <tr className="border-b border-neutral-800 bg-neutral-900/90 text-[11px] font-extrabold uppercase tracking-wider text-neutral-400">
                  <th className="py-3.5 sm:py-4 px-4 sm:px-6 w-[28%] whitespace-nowrap">Vehicle</th>
                  <th className="py-3.5 sm:py-4 px-4 sm:px-6 w-[36%]">What it deals with around Morris</th>
                  <th className="py-3.5 sm:py-4 px-4 sm:px-6 w-[36%]">What the detail focuses on</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-neutral-800/60 text-xs sm:text-sm">
                {vehicleTypesData.map((v, i) => (
                  ...
                  >
                    <td className="py-3.5 sm:py-4 px-4 sm:px-6 font-bold text-white whitespace-nowrap">
                    ...
                    <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-neutral-300 leading-relaxed min-w-55">
                      {v.dealsWith}
                    </td>

                    <td className="py-3.5 sm:py-4 px-4 sm:px-6 text-neutral-200 leading-relaxed font-medium min-w-50">
