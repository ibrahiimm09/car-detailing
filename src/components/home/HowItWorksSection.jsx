...
const steps = [
  {
    ...
    description: <span><a href="/contact" className="text-red-400 hover:text-red-300 underline underline-offset-2 transition-colors">Tell us your vehicle</a>, your town, and roughly what you are after. A photo helps if the inside is rough. Reyes usually gets back to you the same day with a <a href="/cost-calculator" className="text-red-400 hover:text-red-300 underline underline-offset-2 transition-colors">detailing price</a>.</span>
  },
  {
    step: "02",
