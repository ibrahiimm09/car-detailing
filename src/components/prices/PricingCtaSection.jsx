...
export default function PricingCtaSection() {
  return (
    <section id="cta" className="relative bg-neutral-950 py-16 sm:py-20 lg:py-24 border-t border-neutral-800  overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Sleek Minimal Consultation Banner Card matching Service Area CTA */}
          ...
          <div className="relative z-10 flex flex-col items-center text-center gap-6 sm:gap-8">
            ...
            <div className="max-w-2xl space-y-3 mx-auto">
              ...
              <p className="text-xs sm:text-sm text-neutral-300 leading-relaxed font-normal">
                The calculator gets you close. For a firm number, send us a couple of photos of the interior and we will come back the same day with a real price.
              </p>
            </div>
