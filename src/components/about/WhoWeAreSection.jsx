        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-start order-2 lg:order-1">
            <div className="relative group w-full max-w-md lg:max-w-none h-full">
              ...
              <div className="absolute -inset-1.5 bg-linear-to-r from-red-600/30 via-amber-500/20 to-red-600/30 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 group-hover:blur-2xl transition duration-500 pointer-events-none" />

              {/* Main Image Container Card */}
              <div className="relative w-full h-110 sm:h-125 lg:h-135 rounded-3xl bg-neutral-900 border border-neutral-800/90 overflow-hidden shadow-2xl transition-all duration-500 group-hover:scale-[1.01] group-hover:border-red-500/40 flex flex-col">
          ...
          <div className="lg:col-span-7 space-y-6 text-left order-1 lg:order-2">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white font-['Outfit'] tracking-tight leading-[1.15]">
              Who <span className="text-transparent bg-clip-text bg-linear-to-r from-red-500 to-amber-500">We Are</span>
            </h2>
