...
import serviceAreaHeroImg from '../../assets/servicearea/morris-mn-car-detailing-service-areas.webp';
...
export default function ServiceAreaHeroSection() {
  ...
  return (
    <section className="relative w-full overflow-hidden  bg-neutral-950">
      ...
      {/* ========================================================
          HERO UPPER SECTION
          Same responsive height and layout as AboutHeroSection
          ======================================================== */}
      <div className="relative w-full h-[52dvh] sm:h-[62dvh] md:h-[calc(100dvh-92px)] min-h-[360px] sm:min-h-[420px] md:min-h-[480px] max-h-[740px] flex flex-col justify-between overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
          <img
            src={imageSrc}
            alt="Dos Bros Auto Detailing service areas covering Morris, MN and surrounding Stevens County towns"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center w-full">
            ...
            {/* RIGHT COLUMN: Sleek, Minimal Typography Matching About Hero */}
            <div className="lg:col-span-6 xl:col-span-5 flex flex-col items-center text-center space-y-3 sm:space-y-4 pt-8 sm:pt-14 md:pt-20 lg:pt-0">
              ...
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-[42px] font-bold text-white font-['Outfit'] tracking-tight leading-[1.18]">
                Where We Detail: <br className="hidden sm:block" />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-amber-500">
                  Morris, MN and Surrounding Towns
                </span>
              </h1>
        ...
        <div className="relative w-full overflow-hidden shrink-0 leading-none z-20 pointer-events-none -mb-0.5">
          ...
          >
            <defs>
              <linearGradient id="serviceAreaCurveStroke" x1="0%" y1="0%" x2="100%" y2="0%">
            ...
            <path
              ...
              stroke="url(#serviceAreaCurveStroke)"
              strokeWidth="1.5"
      ...
      {/* ========================================================
          ...
          ======================================================== */}
      <div id="service-area-intro" className="relative bg-neutral-950 py-12 sm:py-10 lg:py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-5 sm:space-y-6">
          ...
          <p className="text-sm sm:text-base lg:text-[17px] text-neutral-300 font-light leading-relaxed tracking-wide">
            Dos Bros Detailing is a mobile detailing service based in Morris, Minnesota. We are two brothers from town, and we bring interior and exterior detailing to your driveway, your workplace, or your farm site anywhere in west central Minnesota. There is nothing to drop off and nowhere to drive.
          </p>

          {/* Intro Paragraph 2 */}
          <p className="text-sm sm:text-base lg:text-[17px] text-neutral-300 font-light leading-relaxed tracking-wide">
            We work across Stevens County and out into Pope, Douglas, Grant, Swift, Big Stone, and Otter Tail counties. If your town is on this page, we come to you. If it is not, ask us anyway. We travel further than most people expect.
          </p>

          {/* Intro Paragraph 3 with Phone Link */}
          <p className="text-sm sm:text-base lg:text-[17px] text-neutral-300 font-light leading-relaxed tracking-wide">
            Call{' '}
            <a
              href="tel:3202873573"
            ...
            or send us your town with a quote request.
          </p>

          {/* Minimal Contact & Quote Buttons */}
