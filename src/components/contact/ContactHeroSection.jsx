...
export default function ContactHeroSection() {
  const imageSrc = typeof contactHeroImg === 'object' ? contactHeroImg.src : contactHeroImg;
  ...
  return (
    <section className="relative w-full overflow-hidden  bg-neutral-950">
      ...
      <div className="relative w-full h-[52dvh] sm:h-[62dvh] md:h-[calc(100dvh-92px)] min-h-90 sm:min-h-105 md:min-h-120 max-h-185 flex flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-1 flex items-center">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 items-center w-full">
            ...
            {/* RIGHT COLUMN: Sleek, Minimal Typography Matching About & Service Area Hero */}
            <div className="lg:col-span-6 xl:col-span-5 flex flex-col items-center text-center space-y-3 sm:space-y-4 pt-8 sm:pt-14 md:pt-20 lg:pt-0">
              ...
              <p className="text-xs sm:text-sm lg:text-base text-neutral-300 font-light leading-relaxed max-w-md">
                Tell us what you drive and where you are. We will send you a straight price.
              </p>
        ...
        <div className="relative w-full overflow-hidden shrink-0 leading-none z-20 pointer-events-none -mb-0.5">
          ...
          >
            <defs>
              <linearGradient id="contactCurveStroke" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      {/* ========================================================
          ...
          ======================================================== */}
      <div id="contact-intro" className="relative bg-neutral-950 py-12 sm:py-10 lg:py-14">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-5 sm:space-y-6">
          ...
          <p className="text-sm sm:text-base lg:text-[17px] text-neutral-300 font-light leading-relaxed tracking-wide">
            Dos Bros Detailing is a mobile detailing service run by two brothers in Morris, Minnesota. We come to your driveway, your workplace, or your farm site, so there is nothing to drop off and nowhere to drive.
          </p>

          {/* Intro Paragraph 2 */}
          <p className="text-sm sm:text-base lg:text-[17px] text-neutral-300 font-light leading-relaxed tracking-wide">
            The fastest way to get a price is the form below. If you would rather just call, that works too. Either way you are talking to Reyes or Mariano, not a call center.
          </p>
          ...
          {/* Minimal Contact & Form Scroll Buttons */}
